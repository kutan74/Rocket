...
class ZeplinSelectProjectView: UIView {
    let title: UILabel = {
        let label = UILabel()
        label.text = "Let"
    ...
    let subTitleLabel: UILabel = {
        let label = UILabel()
        label.text = "Select the project you want to work on"
        label.textColor = .greyishBrown
    ...
    var flowLayout: UICollectionViewFlowLayout = {
        ...
        layout.itemSize = .init(width: 263, height: 217)
...
extension ZeplinSelectProjectView {
    func layoutViews() {
